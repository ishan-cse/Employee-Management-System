<?php
  ...
  if(!empty($_POST))
  {
    ...
    $update="UPDATE employee SET emp_name='$emp_name',emp_email='$emp_email',emp_mobile='$emp_mobile',emp_address='$emp_address',emp_nid='$emp_nid',emp_joining_date='$emp_joining_date',emp_photo='$imageName',employee_type_id='$employee_type_id' WHERE emp_slug='$emp_slug'";
