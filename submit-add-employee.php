<?php
  ...
  if(!empty($_POST))
  {
     ...
     $insert="insert into employee(emp_name,emp_email,emp_mobile,emp_address,emp_nid,emp_joining_date,emp_password,emp_photo,employee_type_id,emp_slug) 
     values ('$emp_name','$emp_email','$emp_mobile','$emp_address','$emp_nid','$emp_joining_date','$password','$imageName','$employee_type_id','$emp_slug')";
